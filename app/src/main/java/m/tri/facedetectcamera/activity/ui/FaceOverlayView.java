 ...
 * 一个视图控件类去显示人脸.
 * 继承自View
 * 实现的效果:有蓝色方框叠加在人脸处，并且标志人脸图片相关信息
 */
public class FaceOverlayView extends View {
    ...
    private FaceResult[] mFaces;   //FaceResult类别
    private double fps;
    private boolean isFront = false;

    public FaceOverlayView(Context context) {
        super(context);           //继承自View的基本功能
        initialize();
    }

    private void initialize() {
        //Android 屏幕分辩率中有类DisplayMetics提供Andorid.util 包下的DisplayMetrics 类
        ...
        mTextPaint.setColor(Color.BLUE);     //字体设置成蓝色
    ...
    /**
     * 重载ondraw方法，实现方框追踪人脸，其实就是 人脸识别线程 将人脸位置告诉它，该View实时在人脸附近重新绘制方框
     */
    @Override
    protected void onDraw(Canvas canvas) {
        ...
        if (mFaces != null && mFaces.length > 0) {
            ...
            RectF rectF = new RectF();       //矩形类
            for (FaceResult face : mFaces) {
                PointF mid = new PointF();
                face.getMidPoint(mid);       //获得人脸中点位置，为画矩形框做准备
